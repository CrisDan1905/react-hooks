...
The reason to use 'React.useState' instead of just a plain variable in react is that it will tell React to re-render the current component anytime the state changes.
Otherwise, you should tell React manually to update the current component's view.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=01%3A%20useState%3A%20greeting&em=danilo1905%40outlook.com).
